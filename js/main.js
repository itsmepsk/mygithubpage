...
var scrollers = {
  ...
  "#scroller-push": [ "#development-push", "#nav-development" ],
  "#scroller-pyd": [ "#development-pyd", "#nav-development" ],
  "#scroller-tpsw": [ "#development-tpsw", "#nav-development" ],
  "#scroller-misc": [ "#development-misc", "#nav-development" ]
};

var maskIds = [
  "#mask-electrons", "#mask-dynamics", "#mask-solvent", "#mask-quantum",
  "#mask-push", "#mask-pyd", "#mask-tpsw", "#mask-misc"
];
